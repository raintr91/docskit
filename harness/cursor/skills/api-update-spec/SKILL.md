...
1. Resolve ID / slug to `product/surfaces/<surface>/modules/CMP-*/<slug>/`; read backend YAML trio
...
- [ ] **ID Resolved:** Resolved target ID/slug to `product/surfaces/<surface>/modules/CMP-*/<slug>/`.
