...
| Load | Do not load |
|------|-------------|
| Target `product/surfaces/.../modules/CMP-*/<slug>/{id}.bundle.yaml` — **SSOT** patch | `ir/*.yaml` — regenerated by split |
...
```text
product/surfaces/<surface>/modules/CMP-*/<slug>/{id}.bundle.yaml   # patch here
product/surfaces/<surface>/modules/CMP-*/<slug>/ir/*.yaml          # read-only — from split
