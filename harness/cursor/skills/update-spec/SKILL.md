...
| Load | Do not load |
|------|-------------|
| Target `product/surfaces/.../modules/CMP-*/functions/[Screen | API]/{id}.bundle.yaml` — **SSOT** patch | `ir/*.yaml` — regenerated by split |
...
```text
product/surfaces/.../modules/CMP-*/functions/[Screen | API]/{id}.bundle.yaml   # patch here
product/surfaces/.../modules/CMP-*/functions/[Screen | API]/ir/*.yaml          # read-only — from split
