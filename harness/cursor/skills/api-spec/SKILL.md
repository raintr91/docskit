...
7. Request/response, validation, filters, errors; OpenAPI + mock from spec
8. Record `openQuestions` instead of silent guesses; defer unmerged portal specs to `pendingTechDebt`
...
- [ ] **Error Matrix Documented:** Explicitly specified `#err:*` tags in `01-backend-spec.yaml` and `$ref` responses in `02-openapi.yaml` (including 403 IDOR, 404 Not Found, 422 Validation).
