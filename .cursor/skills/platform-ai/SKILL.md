...
description: /platform-ai — build and maintain the independent Docskit MCP package.
disable-model-invocation: true
---

# /platform-ai — build Docskit MCP

Use this skill to design, implement, test, package, and release **Docskit as an
...
| Docskit installers and managed harness | Docs/spec content belonging to a product hub |
| Docskit-owned architecture skills/assets | Cross-repository workspace topology |
...
created in destination docs/code hubs; Docskit may merge only its owned skill
...
- Shipped files contain only Docskit-owned tools and harness assets.
